...
@Component({
  selector: 'app-tag-extractor',
  templateUrl: './tag-extractor.component.html',
  styleUrls: ['./tag-extractor.component.scss']
})
export class TagExtractorComponent implements OnInit {
videoUrl:any;
  videoId: any;
...
this.videoId=vid;
  this.coreService.getVideoTagsById(this.videoId).subscribe((res:any)=>{
    if(res.success){
      this.tags=res.data.snippet.tags;
